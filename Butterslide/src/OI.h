...
private:
	...
	//std::shared_ptr<JoystickButton> strafePID;
	std::shared_ptr<JoystickButton> forwardPID;
	std::shared_ptr<JoystickButton> liftOff;
	std::shared_ptr<JoystickButton> shootSetPointBB;
	std::shared_ptr<JoystickButton> punchOut;
	std::shared_ptr<JoystickButton> punchIn;
	std::shared_ptr<JoystickButton> activateVision;
	std::shared_ptr<JoystickButton> rotateToTarget;
	std::shared_ptr<JoystickButton> GearIn;
	std::shared_ptr<JoystickButton> GearOut;
...
public:
	...
	std::shared_ptr<Joystick> getCaptain();
	bool driverIsXbox = false;
