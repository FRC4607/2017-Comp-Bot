...
std::shared_ptr<CANTalon> RobotMap::gearIntake;
std::shared_ptr<CANTalon> RobotMap::gearLift;
std::shared_ptr<Solenoid> RobotMap::gearIsInXDDD;
std::shared_ptr<Solenoid> RobotMap::gearIsNotInXDDD;
std::shared_ptr<Solenoid> RobotMap::gearIsVertical;
...
void RobotMap::init() {
    ...
    pneumaticsRearRight.reset(new DoubleSolenoid(11, 6, 7));
    lw->AddActuator("Pneumatics", "Rear Right", pneumaticsRearRight);
    
    pneumaticsFrontStrafe.reset(new DoubleSolenoid(0, 4, 5));
    lw->AddActuator("Pneumatics", "Front Strafe", pneumaticsFrontStrafe);
    
    pneumaticsRearStrafe.reset(new DoubleSolenoid(0, 6, 7));
  ...
  //  drivetrainForwardPIDSource.reset(new FieldOrientedPIDSource(drivetrainEncoderRearLeft, drivetrainEncoderRightStrafe));
    ...
    // Gearage Motors
    gearIntake.reset(new CANTalon(26));
    gearLift.reset(new CANTalon(29));

    //Gearage LEDs
    gearIsInXDDD.reset(new Solenoid(0));
    gearIsNotInXDDD.reset(new Solenoid(1));
